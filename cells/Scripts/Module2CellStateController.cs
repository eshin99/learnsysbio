...
public class Module2CellStateController : MonoBehaviour
{
    ...
    private int contactForApoptosis;
    ...
    void Start()
    {
        ...
        cellState = "Move";
        contactCount = 0;
        contactForApoptosis = -1; // no apoptosis via contact
    ...
    void FixedUpdate()
    {
        ...
        else if (((age == cellDeathAge) || contactCount == contactForApoptosis) && gameObject.tag != "Stem Cell")
        {
            readyToDie = true;
    ...
    void Divide()
    {
        ...
        {
            newCell.GetComponent<Module2CellStateController>().numberCellDivision = numberCellDivision;
