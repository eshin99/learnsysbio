...
public class Module3CellStateController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        else if (((age == cellDeathAge) || contactCount == contactForApoptosis) && gameObject.name != "Cell")
        {
            readyToDie = true;
    ...
    void Divide()
    {
        ...
        {
            newCell.GetComponent<Module3CellStateController>().numberCellDivision = numberCellDivision;
